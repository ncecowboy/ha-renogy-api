...
from renogyapi.exceptions import UrlNotFound, NotAuthorized, APIError, RateLimit
...
class OpenEVSEFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            renogy = api(secret_key=user_input[CONF_SECRET_KEY], access_key=user_input[CONF_ACCESS_KEY])
            # Test connection
            try:
                renogy.get_devices()
